...
class AutenticacaoServicoTest {
  ...
  class loginUsuario {
    ...
    void deveFazerLoginComSucesso() {
      ...
      when(tokenServico.gerarToken(usuario)).thenReturn(token);
  ...
  class cadastrarUsuario {
    ...
    void deveCriarUsuarioComSucesso() {
      ...
      // Arrange
      CadastroRequest requisicao = new CadastroRequest(
          "Mateus",
          "Teste",
      ...
      // Act
      CadastroResponse resposta = autenticacaoServico.cadastrarUsuario(requisicao);
    ...
    void deveRetornarExcecaoInfoInvalida() {
      ...
      // Arrange
      CadastroRequest requisicaoInvalida = new CadastroRequest(
          null,
          null,
          "emailinvalido",
          "INV12345",
    ...
    void deveRetornarExcecaoEmailInvalido() {
      ...
      // Arrange
      CadastroRequest requisicaoEmailCadastrado = new CadastroRequest(
          "Mateus",
          "Teste",
  ...
  class excluirUsuarioPorEmail {
    ...
    void deveEcluirUsuario() {
      ...
      // Act
      ExcluirContaResponse resposta = autenticacaoServico.excluirUsuarioPorEmail(email);
