...
public class TextSearchRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID>
    implements TextSearchRepository<T, ID> {

  private final EntityManager entityManager;

  public TextSearchRepositoryImpl(Class<T> domainClass, EntityManager entityManager) {
    super(domainClass, entityManager);
    this.entityManager = entityManager;
  }

  public TextSearchRepositoryImpl(
